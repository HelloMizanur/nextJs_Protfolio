            ...
            {Object.keys(SKILLS).map((t) => (
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    tab === t ? "0 0 20px rgba(124,58,237,0.4)" : "none",
                }}
              >
                {t}
              </button>
          ...
          {[
            {
              ...
              detail:
                "Graduated with a degree in CSE. Core studies included Data Structures, Algorithms, Database Systems, Computer Networks, and Software Engineering.",
            },
            {
              period: "2024 – 2026",
              icon: "📚",
              ...
              detail:
                "Advanced studies building on the CSE foundation, deepening expertise in software development methodologies, research, and emerging technologies.",
            },
            {
              period: "2026",
              icon: "⚡",
              ...
              detail:
                "Intensive bootcamp covering HTML, CSS, JavaScript, React.js, Node.js, Express, MongoDB, Firebase, and modern full-stack development practices.",
            },
          ].map((e, i) => (
